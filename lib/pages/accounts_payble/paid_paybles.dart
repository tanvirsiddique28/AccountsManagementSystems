...
class PaidPaybles extends StatefulWidget {
  final String? date,name,amount,phone;
  PaidPaybles({Key? key,this.date,this.name,this.amount,this.phone}) : super(key: key);

  @override
  State<PaidPaybles> createState() => _PaidPayblesState();
}

class _PaidPayblesState extends State<PaidPaybles> {
  //------controllers-------------
  ...
  void updateData()async{
    await FirebaseFirestore.instance.collection('paybles').doc(uid).collection('pay').doc(_phoneController.text).set({
  ...
  void deleteData()async{
    await FirebaseFirestore.instance.collection('paybles').doc(uid).collection('pay').doc(_phoneController.text).delete();
